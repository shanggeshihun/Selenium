...
START_URL = 'https://www.vvvdj.com/sort/c3/8-0-0-6-1.html'
    ...
    def run(self):
        ...
        while ENTRANCE_QUEUE_NOT_EMPTY:
            try:
                ...
                print(f'\t\t当前取出entrance_url{entrance_url}')
...
def main():
    ...
    while not entrance_url_queue.empty():
        print('\t\tentrance_url_queue 剩余元素:', list(entrance_url_queue.queue))
        pass
    ...
    while not m3u8_url_queue.empty():
        print('\t\tm3u8_url_queue 剩余元素:', list(m3u8_url_queue.queue))
        pass
